...
- [libcurl](http://php.net/manual/en/curl.installation.php) if you plan to use the HTTP\CURLRequest library

---

# Tasks for Today Management System

A small internal tool for tracking daily to-do items, built with **CodeIgniter 4** and **MySQL** for the IT0049 — Web System Technologies laboratory activity.
...
|------|-----|-------------|
| Welcome | `/` | Shows only tasks scheduled for today |
| Task List | `/tasks` | Shows all tasks, ordered by date |
...
- (Optional) `zip` extension for Composer performance
